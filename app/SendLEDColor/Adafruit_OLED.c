...
*/
    ...
    GPIOPinWrite(GPIOA0_BASE, 0x8, 0x00);  // DC line
    GPIOPinWrite(GPIOA0_BASE, 0x10, 0x00); // CS line
    MAP_SPITransfer(GSPI_BASE, &TxBuff, 0, 1, SPI_CS_ENABLE);
    GPIOPinWrite(GPIOA0_BASE, 0x10, 0x10); // CS line
}
//*****************************************************************************
...
*/
    TxBuff = c;
    GPIOPinWrite(GPIOA0_BASE, 0x8, 0x8);  // DC line
    GPIOPinWrite(GPIOA0_BASE, 0x10, 0x00); // CS line
    SPITransfer(GSPI_BASE, &TxBuff, 0, 1, SPI_CS_ENABLE);
    GPIOPinWrite(GPIOA0_BASE, 0x10, 0x10); // CS line
}
